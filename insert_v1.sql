INSERT INTO ADDRESS_TYPE(TYPE) VALUES('ETHEREUM');
INSERT INTO ADDRESS_TYPE(TYPE) VALUES('BITCOIN');
INSERT INTO ADDRESS_TYPE(TYPE) VALUES('BITCOIN CASH');
INSERT INTO ADDRESS_TYPE(TYPE) VALUES('LITECOIN');
INSERT INTO ADDRESS_TYPE(TYPE) VALUES('CARDANO');
INSERT INTO ADDRESS_TYPE(TYPE) VALUES('DASH');
INSERT INTO ADDRESS_TYPE(TYPE) VALUES('ZCASH');
INSERT INTO ADDRESS_TYPE(TYPE) VALUES('DECRED');
INSERT INTO ADDRESS_TYPE(TYPE) VALUES('STRATIS');
INSERT INTO ADDRESS_TYPE(TYPE) VALUES('DOGECOIN');
...
INSERT INTO CURRENCY(NAME, CODE, TYPE, BALANCE_ENDPOINT,BALANCE_RESPONSE_PATH, BALANCE_DECIMAL_PLACE, ADDRESS_TYPE, IS_EXCHANGE_CURRENCY) VALUES('Bitcoin','BTC',2,'https://blockexplorer.com/api/addr/{}','balance','0', 2, 1);
INSERT INTO CURRENCY(NAME, CODE, TYPE, BALANCE_ENDPOINT,BALANCE_RESPONSE_PATH, BALANCE_DECIMAL_PLACE, ADDRESS_TYPE) VALUES('Bitcoin Cash','BCH',2,'https://bitcoincash.blockexplorer.com/api/addr/{}/?noTxList=1','balance','0', 3);
...
INSERT INTO CURRENCY(NAME, CODE, TYPE, BALANCE_ENDPOINT,BALANCE_RESPONSE_PATH, BALANCE_DECIMAL_PLACE, ADDRESS_TYPE) VALUES('Litecoin','LTC',2,'https://insight.litecore.io/api/addr/{}','balance','0', 4);
INSERT INTO CURRENCY(NAME, CODE, TYPE, BALANCE_ENDPOINT,BALANCE_RESPONSE_PATH, BALANCE_DECIMAL_PLACE, ADDRESS_TYPE) VALUES('Cardano','ADA',2,'https://cardanoexplorer.com/api/addresses/summary/{}','Right,caBalance,getCoin','0', 5);
...
INSERT INTO CURRENCY(NAME, CODE, TYPE, BALANCE_ENDPOINT,BALANCE_RESPONSE_PATH, BALANCE_DECIMAL_PLACE, ADDRESS_TYPE) VALUES('Dash','DASH',2,'https://explorer.dash.org/chain/Dash/q/addressbalance/{}','raw',0, 6);
...
INSERT INTO CURRENCY(NAME, CODE, TYPE, BALANCE_ENDPOINT,BALANCE_RESPONSE_PATH, BALANCE_DECIMAL_PLACE, ADDRESS_TYPE) VALUES('Zcash','ZEC',2,'https://zcash.blockexplorer.com/api/addr/{}','balance','0', 7);
INSERT INTO CURRENCY(NAME, CODE, TYPE, BALANCE_ENDPOINT,BALANCE_RESPONSE_PATH, BALANCE_DECIMAL_PLACE, ADDRESS_TYPE) VALUES('Decred','DCR',2,'https://mainnet.decred.org/api/addr/{}','balance','0',8);
INSERT INTO CURRENCY(NAME, CODE, TYPE, BALANCE_ENDPOINT,BALANCE_RESPONSE_PATH, BALANCE_DECIMAL_PLACE, ADDRESS_TYPE) VALUES('Stratis','STRAT',2,'https://chainz.cryptoid.info/strat/api.dws?q=getbalance&a={}','raw','0', 9);
INSERT INTO CURRENCY(NAME, CODE, TYPE, BALANCE_ENDPOINT,BALANCE_RESPONSE_PATH, BALANCE_DECIMAL_PLACE, ADDRESS_TYPE) VALUES('Dogecoin','DOGE',2,'https://dogechain.info/api/v1/address/balance/{}&tag=latest&apikey=SFUJUSGCDN6B9FXIEUYWAMWYSTJYJT2A1X','balance','0', 10);
